...
\frame{ \transdissolve[duration=0.25] 
  ...
  \begin{tabular}{lll}
    Name                & Role                  & Major\\
    \hline
    Lee, Joe            & Business Manager      & CS\\ \pause
    Vemparala, Swapna   & Project Manager       & CS\\ \pause
    Wong, Amber         & Risk Manager          & CS\\ \pause
    Narad, Shivalik     & Development Manager   & CS\\ \pause
    Phan, Nam           & Development Manager   & CS\\ \pause
    Alcoran, Ryan       & Test Manager          & CS
  \end{tabular}
  \end{center}
}
...
\frame{ \transdissolve[duration=0.25] 
  ...
  {\Huge Tools} \\[1em]
    ...
    \begin{itemize}
      ...
      \item Software Configuration Management: {\bf Git} \pause 
        used with command-line {\bf git} client or with 3rd-party 
        client applications like EGit. \pause
...
\frame{ \transdissolve[duration=0.25] 
  \frametitle{Software hosting facilities}
    ...
    control and source code management (SCM) system. \cite{hosting} 
    \pause \\[1em]
...
\frame{ \transdissolve[duration=0.25] 
  \frametitle{Software hosting facilities}
    {\Huge Github vs Others \cite{RCS}} \\[1em] \pause
...
\frame{ \transdissolve[duration=0.25] 
    \begin{figure}[h!]   
      \includegraphics[width=0.8\textwidth]{Screenshots/github/1create-a.png}
      \caption{Click on the "Create a new repo" icon.}
    \end{figure}
}

\frame{ \transdissolve[duration=0.25] 
    \begin{figure}[h!]   
      \includegraphics[width=0.8\textwidth]{Screenshots/github/1create-b.png}
      \caption{Name, describe, and initialize a new repo with a README file.}
    \end{figure}
}

\frame{ \transdissolve[duration=0.25] 
    \begin{figure}[h!]   
      \includegraphics[width=0.8\textwidth]{Screenshots/github/1create-c.png}
      \caption{New repo named "newrepo" initialized. Copy the SSH address for the git repo.}
    \end{figure}
}

\frame{ \transdissolve[duration=0.25] 
    \begin{figure}[h!]   
      \includegraphics[width=0.8\textwidth]{Screenshots/github/2clone-a.png}
      \caption{The command to clone the new repo at the address git@github.com:cs160-q06/newrepo.git.}
    \end{figure}
}

\frame{ \transdissolve[duration=0.25] 
    \begin{figure}[h!]   
      \includegraphics[width=0.8\textwidth]{Screenshots/github/2clone-b.png}
      \caption{Cloned.}
    \end{figure}
}
...
\frame{ \transdissolve[duration=0.25] 
    \begin{figure}[h!]   
      \includegraphics[width=0.8\textwidth]{Screenshots/github/2clone-c.png}
      \caption{The cloned repo is in the directory named "newrepo".}
    \end{figure}
}

\frame{ \transdissolve[duration=0.25] 
    \begin{figure}[h!]   
      \includegraphics[width=0.8\textwidth]{Screenshots/github/2clone-d.png}
      \caption{Enter the newrepo directory and list the files inside.}
    \end{figure}
}

\frame{ \transdissolve[duration=0.25] 
    \begin{figure}[h!]   
      \includegraphics[width=0.8\textwidth]{Screenshots/github/3edit-a.png}
      \caption{Edit a file in the repo.}
    \end{figure}
}

\frame{ \transdissolve[duration=0.25] 
    \begin{figure}[h!]   
      \includegraphics[width=0.8\textwidth]{Screenshots/github/3edit-b.png}
      \caption{Edit a file in the repo.}
    \end{figure}
}
...
\frame{ \transdissolve[duration=0.25] 
    \begin{figure}[h!]   
      ...
      \caption{Add changed files to your next commit using the command "git add ." to add all changes in the present working directory.}
    \end{figure}
}

\frame{ \transdissolve[duration=0.25] 
    \begin{figure}[h!]   
      \includegraphics[width=0.8\textwidth]{Screenshots/github/5commit-a.png}
...
\frame{ \transdissolve[duration=0.25] 
    \begin{figure}[h!]   
      \includegraphics[width=0.8\textwidth]{Screenshots/github/5commit-b.png}
      \caption{Enter a commit message to summarize your changes.}
    \end{figure}
}

\frame{ \transdissolve[duration=0.25] 
    \begin{figure}[h!]   
      \includegraphics[width=0.8\textwidth]{Screenshots/github/5commit-c.png}
      \caption{Commit complete.}
    \end{figure}
}

\frame{ \transdissolve[duration=0.25] 
    \begin{figure}[h!]   
      \includegraphics[width=0.8\textwidth]{Screenshots/github/6push-a.png}
      \caption{Push changes to the repository using the command "git push".}
    \end{figure}
}

\frame{ \transdissolve[duration=0.25] 
    \begin{figure}[h!]   
      \includegraphics[width=0.8\textwidth]{Screenshots/github/6push-b.png}
      \caption{Changes committed and pushed to the repository.}
    \end{figure}
}
...
\frame{ \transdissolve[duration=0.25] 
  ...
  \framesubtitle{Tracking and controlling changes in software}
    ...
    {\Large Subversion} \cite{git} \pause
    \begin{itemize}
...
\frame{ \transdissolve[duration=0.25] 
  \frametitle{Software hosting facilities}
    {\Huge GitHub Windows client installation} \\[1em]
   \begin{figure}[h!]   
...
\frame{
  ...
  \framesubtitle{Netbeans, Eclipse, Emacs} \pause
    ...
    \item {\bf NetBeans IDE} \pause
      ...
      \end{itemize}
    \item {\bf Eclipse} \cite{eclipse} \pause
      \begin{itemize}
...
\frame{ \transdissolve[duration=0.25]
  \frametitle{Project Management Tools}
    ...
    run on a variety of different operating systems'' \cite{proj} 
    \\[2em] \pause
    \begin{itemize}
